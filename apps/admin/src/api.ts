...
export const api = {
  ...
  updateRole: (id: number, body: Partial<LookRole>) => request<LookRole>(`/admin/look-roles/${id}`, { method: "PUT", body }),
  ...
  updateStep: (id: number, body: Partial<TutorialStep>) => request<TutorialStep>(`/admin/tutorial-steps/${id}`, { method: "PUT", body }),
  ...
  updateStore: (id: number, body: Partial<Store>) => request<Store>(`/admin/stores/${id}`, { method: "PUT", body }),
  deleteStore: (id: number) => request<void>(`/admin/stores/${id}`, { method: "DELETE" }),
  ...
  updateOffer: (id: number, body: Partial<StoreOffer>) => request<StoreOffer>(`/admin/store-offers/${id}`, { method: "PUT", body }),
